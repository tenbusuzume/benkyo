...
public class HeloController {
	...
	public void init() {
		...
		/*
		 * MyData d2 = new MyData(); d2.setName("hanako"); d2.setAge(15);
		 * d2.setMail("hanako@flower"); d2.setMemo("my girl friend");
		 * repository.saveAndFlush(d2); MyData d3 = new MyData();
		 * d3.setName("sachiko"); d3.setAge(37); d3.setMail("sachiko@happy");
		 * d3.setMemo("my work friend"); repository.saveAndFlush(d3);
		 */
